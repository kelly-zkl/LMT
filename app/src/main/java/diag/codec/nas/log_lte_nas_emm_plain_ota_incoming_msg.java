...
public class log_lte_nas_emm_plain_ota_incoming_msg {
    ...
    static public void decode(log_packet packet) {
        ...
        System.out.println("log_lte_nas_emm_plain_ota_incoming_msg");
        packet.log_name = "log_lte_nas_emm_plain_ota_incoming_msg";
